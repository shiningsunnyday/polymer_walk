...
class MolTestDatasetWrapper(object):
    ...
    def get_train_validation_data_loaders(self, train_dataset):
        if self.splitting == 'random':
            ...
            train_idx, test_idx, _, _ = train_test_split(indices, indices, test_size=self.test_size, random_state=42)
            valid_idx = []
        ...
        # return train_loader, valid_loader, test_loader
        return train_loader, test_loader, test_loader # use test as valid
